...
CHUANHU_TITLE = i18n("超级数据库Chat 🚀")

CHUANHU_DESCRIPTION = i18n("由Bilibili [土超级数据库虎虎](https://space.bilibili.com/29125536)、[明昭MZhao](https://space.bilibili.com/24807452) 和 [Keldos](https://github.com/Keldos-Li) 开发<br />访问超级数据库Chat的 [GitHub项目](https://github.com/GaiZhenbiao/SDBChatGPT) 下载最新版脚本")
