...
<sup>New!</sup> 现在可以将 SDBChat 作为 PWA 应用程序安装，体验更加原生！支持 Chrome/Edge/Safari 等浏览器。
...
- SDBChat 预设了Prompt模板，点击`加载Prompt模板`，先选择 Prompt 模板集合，然后在下方选择想要的 Prompt。
...
一个浏览器窗口将会自动打开，此时您将可以使用 **SDBChat** 与ChatGPT或其他模型进行对话。
