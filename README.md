...
<h1 align="center">超级数据库 Chat 🐯 SDB Chat</h1>
<div align="center">
...
<p align="center">
	...
	||
      <a href="https://huggingface.co/spaces/JohnSmith9982/SDBChatGPT"><strong>在线体验</strong></a>
      	·
      <a href="https://huggingface.co/login?next=%2Fspaces%2FJohnSmith9982%2FSDBChatGPT%3Fduplicate%3Dtrue"><strong>一键部署</strong></a>
    </p>
  </p>
</div>
...
| [支持模型](#支持模型) | [使用技巧](#使用技巧) | [安装方式](https://github.com/GaiZhenbiao/SDBChatGPT/wiki/使用教程) | [常见问题](https://github.com/GaiZhenbiao/SDBChatGPT/wiki/常见问题) | [给作者买可乐🥤](#捐款) | [加入Telegram群组](https://t.me/tkdifferent) |
| --- | --- | --- | --- | --- | --- |
...
<sup>New!</sup> 现在可以将 超级数据库Chat 作为 PWA 应用程序安装，体验更加原生！支持 Chrome/Edge/Safari 等浏览器。
...
- 超级数据库Chat 预设了Prompt模板，点击`加载Prompt模板`，先选择 Prompt 模板集合，然后在下方选择想要的 Prompt。
...
一个浏览器窗口将会自动打开，此时您将可以使用 **超级数据库Chat** 与ChatGPT或其他模型进行对话。

> **Note**
>
> 具体详尽的安装教程和使用教程请查看[本项目的wiki页面](https://github.com/GaiZhenbiao/SDBChatGPT/wiki/使用教程)。
...
如果问题仍然存在，请查阅该页面：[常见问题](https://github.com/GaiZhenbiao/SDBChatGPT/wiki/常见问题)

该页面列出了**几乎所有**您可能遇到的各种问题，包括如何配置代理，以及遇到问题后您该采取的措施，**请务必认真阅读**。

## 了解更多

若需了解更多信息，请查看我们的 [wiki](https://github.com/GaiZhenbiao/SDBChatGPT/wiki)：

- [想要做出贡献？](https://github.com/GaiZhenbiao/SDBChatGPT/wiki/贡献指南)
- [项目更新情况？](https://github.com/GaiZhenbiao/SDBChatGPT/wiki/更新日志)
- [二次开发许可？](https://github.com/GaiZhenbiao/SDBChatGPT/wiki/使用许可)
- [如何引用项目？](https://github.com/GaiZhenbiao/SDBChatGPT/wiki/使用许可#如何引用该项目)
