...
with gr.Blocks(theme=small_and_beautiful_theme) as demo:
                ...
                with gr.Tabs(elem_id="sdb-toolbox-tabs"):
                    with gr.Tab(label=i18n("对话")):
                        ...
                        with gr.Accordion(label=i18n("上传数据表"), open=True, elem_id="gr-kb-accordion"):
                            ...
                            sql_file = gr.Files(label=i18n("上传"), type="file", file_count='single', file_types=[".xlsx"], elem_id="upload-sql-file")
    ...
    sql_file.upload(handle_sql_upload, [current_model, sql_file], status_display)
