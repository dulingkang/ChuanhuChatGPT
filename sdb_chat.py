...
with gr.Blocks(theme=small_and_beautiful_theme) as demo:
    ...
    demo.load(create_greeting, inputs=None, outputs=[
              user_info, user_name, current_model, like_dislike_area, saveFileName, chatbot, single_turn_checkbox, historySelectList], api_name="load")
    ...
    load_history_from_file_args = dict(
        ...
        outputs=[saveFileName, chatbot, single_turn_checkbox],
    )
    ...
    emptyBtn.click(
        ...
        outputs=[chatbot, status_display, historySelectList, single_turn_checkbox],
        show_progress=True,
