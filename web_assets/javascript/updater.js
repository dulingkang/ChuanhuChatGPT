...
async function getLatestRelease() {
    try {
        const response = await fetch('https://api.github.com/repos/gaizhenbiao/sdbchatgpt/releases/latest');
        if (!response.ok) {
    ...
    try {
        ...
        if (currentVersion) {
            ...
            if (latestVersionTime) {
                const latestVersionInfo = `<a href="https://github.com/gaizhenbiao/sdbchatgpt/releases/latest" target="_blank" id="latest-version-title" style="text-decoration: none;">${latestVersion}</a>`
...
function getUpdateInfo() {
    window.open('https://github.com/gaizhenbiao/sdbchatgpt/releases/latest', '_blank');
    closeUpdateToast();
}
