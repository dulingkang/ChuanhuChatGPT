...
<p align="center">
	...
	||
      <a href="https://huggingface.co/spaces/JohnSmith9982/SDBChatGPT"><strong>Пробная онлайн-версия</strong></a>
      	·
      <a href="https://huggingface.co/login?next=%2Fspaces%2FJohnSmith9982%2FSDBChatGPT%3Fduplicate%3Dtrue"><strong>Развертывание в один клик</strong></a>
    </p>
  </p>
</div>
...
![SDBChat5](https://github.com/GaiZhenbiao/SDBChatGPT/assets/70903329/f2c2be3a-ea93-4edf-8221-94eddd4a0178)
...
### 💪 Мощные функции
- **SDB ассистент**: подобно AutoGPT, полностью автоматизированное решение вашей проблемы;
...
> **Примечание**
>
> Подробные инструкции см. на нашей [wiki-странице](https://github.com/GaiZhenbiao/SDBChatGPT/wiki/使用教程).
...
Если проблема сохраняется, обратитесь к этой странице: [Часто задаваемые вопросы (FAQ)](https://github.com/GaiZhenbiao/SDBChatGPT/wiki/常见问题)
...
Более подробную информацию можно найти в нашей [wiki](https://github.com/GaiZhenbiao/SDBChatGPT/wiki):

- [Как добавить перевод](https://github.com/GaiZhenbiao/SDBChatGPT/wiki/Localization)
- [Как внести вклад](https://github.com/GaiZhenbiao/SDBChatGPT/wiki/贡献指南)
- [Как цитировать проект](https://github.com/GaiZhenbiao/SDBChatGPT/wiki/使用许可#如何引用该项目)
- [Журнал изменений проекта](https://github.com/GaiZhenbiao/SDBChatGPT/wiki/更新日志)
- [Лицензия проекта](https://github.com/GaiZhenbiao/SDBChatGPT/wiki/使用许可)
