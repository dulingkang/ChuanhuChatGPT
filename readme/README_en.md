...
<sup>New!</sup> SDB Chat can now be installed as a PWA application for a more native experience! Supported on Chrome/Edge/Safari etc.
...
A browser window will automatically open, at this point you can use **SDB Chat** to chat with ChatGPT or other models.
